...
- Programming Languages
  ...
  - Python (PyTorch, Flask, scikit-learn, pandas/polars, transformers, NumPy, matplotlib)
  
  - SQL (PostgreSQL, SQLite)

  - TypeScript (D3.js, React) 
...
- **New Muses Project** (Summer 2025)<br>
**Software Engineer Intern** <br>
Full-stack Software Engineering Intern (TypeScript).


- **University of Chicago, Department of Statistics** (Spring-Summer 2025)<br>
**Research Assistant with Jiaqi Li** <br>
Applying techniques from time series and Markov chain theory to machine learning and optimization. 
...
<!-- - Quad Undergraduate Research Scholars Program (Summer 2022) -->
